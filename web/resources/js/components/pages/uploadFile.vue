    ...
    <div class="p-3 border border-white">
        <form class="m-5" enctype="multipart/form-data" @submit.prevent="submit">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="maintenanceStaff" v-model="maintenanceStaff" required="required">
                    <option value="0" disabled selected>--請選擇--</option>
            ...
            <div class="form-group">
                <button type="button" class="btn btn-primary float-right"  @click="uploadContract()">送出</button>
            </div>
        </form>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            uploadContract () {
                ...
                axios.post('/api/AddNewContract', formData, config)
                .then((response) => {
